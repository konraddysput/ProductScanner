...
\end{lstlisting}
\item \textbf{Generowanie raportów} - każdorazowe wywołanie mechanizmów wnioskujących powoduje zapisanie nowo dodanych indywiduów. Dzięki temu system ProductScanner posiada możliwość generowania raportów na podstawie zgromadzonych danych w ontologii. W tym celu użyto języka SPARQL, który pozwolił na stworzenie zpaytań wywoływanych z interfejsu JENA. Przykład otrzymywania danych niezbednych do wygenerowania raportów został przedstawiony w listingu \ref{reportGeneration}
