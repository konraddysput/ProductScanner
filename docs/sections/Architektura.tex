...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth,height=10cm]{"images/diagram przeplywu danych"}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\linewidth]{images/ontology}
